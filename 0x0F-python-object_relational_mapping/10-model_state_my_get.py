...
"""
Script that prints State object with name passed  argument
...
Script should connect to  MySQL server runnimg on `localhost` at port `3306`
Results must ascending order by `states.id`.
If no state has  name you searched for, display Not found
