...
def print_not_attack_combinations(chessboard: "list[list[list[int]]]") -> None:
    """
    Prints all the no-attacking combinations of N-Queens.
...
if _name_ == "_main_":
    ...
    print_not_attack_combinations(n_queens(N))
